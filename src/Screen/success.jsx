...
const Success = () => {
    return (
      <div className='w-full h-screen flex flex-col items-center justify-center px-6 pt-12 box-border font-sans md:w-80 md:h-full md:p-10 md:my-3 md:mx-auto md:bg-green-50 md:rounded-3xl'>
